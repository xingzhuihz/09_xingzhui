    ...
    function displayFiveTitle(json) {
        ...
        ul.innerHTML = "";
        ul.innerHTML += "<li><a href=\"<%=path %>index_home.jsp\" class=\"current\">首页</a></li>";
        ul.innerHTML += "<li><a href=\"<%=path %>subpage.jsp\" class=\"current\">热点文章</a></li>";
        let len = json.length;
        for (let i = 0; i < len; i++) {
            let obj = json[i];
            let id = obj.id;
        ...
        div.innerHTML = "";
        div.innerHTML += "<a href=\"<%=path %>index_home.jsp\">首页</a> |";
        for (let i = 0; i < len; i++) {
            let obj = json[i];
            let id = obj.id;
            let title = obj.title;
    ...
    function displayAllTitle(json) {
        ...
        for (let i = 0; i < 9; i++) {
            ...
            let h1 = obj.h1;
            let a = obj.a;
            ul1.innerHTML += " <li><a href=\"<%=path %>jsps/" + a + "\">" + h1 + "</a></li>";
        ...
        for (let i = 9; i < len; i++) {
            ...
            let h1 = obj.h1;
            let a = obj.a;
            ul2.innerHTML += " <li><a href=\"<%=path %>jsps/" + a + "\">" + h1 + "</a></li>";
